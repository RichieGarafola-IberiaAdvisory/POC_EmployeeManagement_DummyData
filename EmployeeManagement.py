...
# selected_employees = st.sidebar.multiselect('Employee Name',
#                                             employees_df['Employee Name'].unique(),
#                                             default=employees_df['Employee Name'].unique())
# selected_dates_joined = st.sidebar.multiselect('Date Joined',
#                                                employees_df['Date Joined'].unique(),
#                                                default=employees_df['Date Joined'].unique())
...
# selected_terminate_dates = st.sidebar.multiselect('Terminate Date',
#                                                   employees_df['Terminate Date'].unique(),
#                                                   default=employees_df['Terminate Date'].unique())
...
# selected_supervisors = st.sidebar.multiselect('Supervisor',
#                                               employees_df['Supervisor'].unique(),
#                                               default=employees_df['Supervisor'].unique())
...
# selected_origination_dates = st.sidebar.multiselect('Origination Date',
#                                                     employees_df['Origination Date'].unique(),
#                                                     default=employees_df['Origination Date'].unique())
...
# selected_reinvestigation_dates = st.sidebar.multiselect('Reinvestigation Date',
#                                                         employees_df['Reinvestigation Date'].unique(),
#                                                         default=employees_df['Reinvestigation Date'].unique())
...
#     filtered_employees_df = filtered_employees_df[
#         filtered_employees_df['Employee Name'].isin(selected_employees)]

# if selected_dates_joined:
#     filtered_employees_df = filtered_employees_df[
#         filtered_employees_df['Date Joined'].isin(selected_dates_joined)]
...
#     filtered_employees_df = filtered_employees_df[
#         filtered_employees_df['Terminate Date'].isin(selected_terminate_dates)]
...
#     filtered_employees_df = filtered_employees_df[
#         filtered_employees_df['Supervisor'].isin(selected_supervisors)]
...
#     filtered_employees_df = filtered_employees_df[
#         filtered_employees_df['Origination Date'].isin(selected_origination_dates)]
...
#     filtered_employees_df = filtered_employees_df[
#         filtered_employees_df['Reinvestigation Date'].isin(selected_reinvestigation_dates)]
